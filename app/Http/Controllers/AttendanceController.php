...
class AttendanceController
{
    ...
    private function insertAttendanceTapLog(int $sessionId, Attendance $attendance, Students $student, ?int $scheduleId, Carbon $tapTime, string $tapType, int $sequence, string $room, string $validationResult, ?string $remarks = null): int
    {
