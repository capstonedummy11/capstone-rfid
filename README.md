...
| --- | --- | --- | --- |
| 2026-06-22 | Link student and parent login accounts to students, redesign student/parent login, and add dashboards. | `app/Http/Controllers/StudentParentDashboardController.php`, `app/Http/Responses/LoginResponse.php`, `app/Models/Students.php`, `app/Models/User.php`, `database/migrations/2026_06_22_000002_link_students_and_parents_to_users.php`, `resources/js/components/Auth/Login.vue`, `resources/js/layouts/AuthNavbar.vue`, `resources/js/pages/Auth/Login.vue`, `resources/js/pages/StudentParent/Dashboard.vue`, `routes/web.php`, `README.md` | Added student user links and parent-student associations, redirected student/parent accounts to a new attendance dashboard, and redesigned the main login for student/parent access while keeping staff login separate. |
| 2026-06-22 | Make the main login for student/parent and move staff login to a secured route. | `app/Providers/FortifyServiceProvider.php`, `app/Http/Responses/LoginResponse.php`, `resources/js/components/Auth/Login.vue`, `resources/js/pages/Auth/Login.vue`, `routes/web.php`, `README.md` | Reused the existing login form with student/parent and staff modes, added `/secure-login` for admin/instructor/clinic/registrar accounts, and restricted authentication by role for each login type. |
