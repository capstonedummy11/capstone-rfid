...
const pageDescription = computed(() => {
    const labels = {
        ...
        registrar: 'Review student population, sections, strands, and enrollment activity.',
        instructor: 'Review your assigned schedules, attendance records, and online class activity.',
    };

    return labels[props.role] || 'Review report summaries, charts, and downloadable records.';
});
...
<template>
    <div class="min-h-screen bg-slate-100 px-4 py-6 text-slate-950">
        <div class="mx-auto max-w-7xl space-y-5">
            ...
            >
                <div>
                    <p class="text-xs font-bold uppercase text-brand">
                        {{ role }} reporting
                    </p>
            ...
            <section class="grid gap-4 lg:grid-cols-2">
                ...
                >
                    ...
                    <div v-if="chart.data.length" class="space-y-3">
                        <div
                        ...
                        >
                            ...
                            <div class="h-3 overflow-hidden rounded-md bg-slate-100">
                                <div
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-slate-200 text-sm">
                        ...
                        <tbody class="divide-y divide-slate-100">
                            <tr v-for="row in tableRows" :key="`${row.category}-${row.metric}`">
